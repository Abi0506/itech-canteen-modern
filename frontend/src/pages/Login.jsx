        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="bg-surface-container-low rounded-xl p-4 border border-outline/10">
            ...
            <div className="space-y-2 text-xs text-secondary">
              <div className="flex justify-between"><span className="font-semibold text-on-surface">Super Admin</span><span>admin@cafeodoo.com / adminpassword</span></div>
              <div className="flex justify-between"><span className="font-semibold text-on-surface">Cashier</span><span>cashier@cafeodoo.com / cashierpassword</span></div>
              <div className="flex justify-between"><span className="font-semibold text-on-surface">Inventory Mgr</span><span>inventory@cafeodoo.com / inventorypassword</span></div>
              <div className="flex justify-between"><span className="font-semibold text-on-surface">Chef (KDS)</span><span>chef@cafeodoo.com / chefpassword</span></div>
            </div>
          </div>
        </div>
      </div>
