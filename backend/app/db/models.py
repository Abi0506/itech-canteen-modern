...
class VenueSetting(Base):
    ...
    self_ordering_mode = Column(Enum('kiosk', 'qr_table', 'both'), nullable=False, default='qr_table')
    self_order_lock_mode = Column(Enum('pin', 'none', 'otp'), nullable=False, default='pin')
